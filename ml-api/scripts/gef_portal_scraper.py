...
# Constants
PROJECTS_CSV_PATH = os.getenv(
    "PROJECTS_CSV_PATH", os.path.join(project_root, "scripts", "projects.csv")
)
OUTPUT_PATH = os.getenv("OUTPUT_PATH", os.path.join(project_root, "data", "gef-7"))
JSON_PATH = os.getenv(
